    ...
    <section className={styles.section}>
      <Fade {...animCfg}>
        ...
        <div className={styles.content}>
          <p>
            Nykaikaisen kehitysarkkitehtuurin siivittämänä enään ei tarvitse
            puhua web-hotelleista, palvelimista tai julkaisualustoista. Voimme
            abstraktoida kaikki palvelutarpeet niihin erikoistuneille
            kolmansille osapuolille ja jättää kaikki tietoturvahaasteet ja
            ylläpitotoimet heidän hoidettavakseen.
          </p>
          <p>
