      ...
      <div className={styles.content}>
        <div className={styles.headerWrapper}>
          ...
          <h1 className={styles.header}>
            Vaivaton laatutestattu kehityspalvelu joka suunnittelee ja palvelee.
          </h1>
        </div>
        <div className={styles.textContainer}>
          <div className={styles.textColumn}>
            ...
            <p>
              ...
              hakukoneiden algoritmit ja robotit eivät niistä pahemmin piittaa.
            </p>
            <p>
          ...
          <div className={styles.textColumn}>
            ...
            <p>
              Pienellä vuosittaisella lisämaksulla Digiaalto hoitaa satunnaiset
              sisällönmuutokset, mahdolliset ylläpitö askareet ja päivitykset
              puolestasi ilman häiriöitä.
            </p>
            <Button
              href="/tilaa-verkkosivu"
              text="Tilaa Verkkosivu"
