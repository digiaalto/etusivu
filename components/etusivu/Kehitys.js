  ...
  return (
    <section className={styles.section} ref={refs} id="kehitys">
      ...
      <p className={styles.description}>
        ...
        tekniikalla joka ylittää hänen odotukset. Emmekä laskuta teitä
        markkinointitoimiston tavoin ylläpitopalvelulla, jonka tarkoitus on
        hengittää elämää 20 vuotta vanhaan järjestelmään.
      </p>
