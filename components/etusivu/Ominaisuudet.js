...
const Ominaisuudet = () => {
  return (
    <div className={styles.container}>
      <Ominaisuus>
        <Icon svg={brainicon} />
        <h3 className={styles.ominaisuusHeader}>
          Asiakaslähtöinen suunnittelu.
        </h3>
        <OText>
          <p>
            Designinimme päätarkoitus on saada käyttäjä pysymyään sivuillasi,
            oppimaan yrityksestäsi ja kiinnostumaan palveluistasi. Viimeinen
            asia minkä haluamme tapahtuvan, on että vierailija poistuu
            ennenaikaisesti ja kääntyy kilpailijanne puoleen. Opimme sinulta
            kuka asiakkaasi on, ja yhdistämme hänen tarpeensa sinun tarjoamiin
      ...
      <Ominaisuus>
        <Icon svg={cogIcon} />
        <h3 className={styles.ominaisuusHeader}>Nykyaikainen arkkitehtuuri.</h3>
        <OText>
          <p>
      ...
      <Ominaisuus>
        <Icon svg={heartIcon} />
        <h3 className={styles.ominaisuusHeader}>Vaivaton palvelu.</h3>
        <OText>
          <p>
...
const Ominaisuus = ({ children }) => {
  return <div className={styles.ominaisuus}>{children}</div>
}
const OText = ({ children }) => <div className={styles.oText}>{children}</div>
const Icon = ({ svg }) => <div className={styles.iconWrapper}>{svg}</div>
